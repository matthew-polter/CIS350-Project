package games;
/**
 * A Class to give Euchre cards their required attributes.
...
public class Card {
	...
	/**
	 * The name of the card in the Euchre deck. Ex. "King".
	 */
    private String name;
    /**
     * The color of the card. Black or Red.
     */
    private String color;
    /**
     * The suit of the card. Ex. Diamonds, Clubs.
     */
    private String suit;
    /**
     * What rank the card is in the round being played. Depends on the trump suit.
     */
    private int rank;

    /**
     * Constructor to set the attributes of a card for the Euchre game.
     * 
     * @author Matthew Polter
