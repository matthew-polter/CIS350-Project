...
/**
 * A Class to simulate a game of Sudoku.
...
public class Sudoku {
	...
	/**
	 * The starting state of the level. Updates as the player plays the game.
	 */
    private String[][] levelStart = new String[9][9];
    /**
     * The complete and correct Sudoku solution. Used to compare to the players board.
     */
    private String[][] masterKey = new String[9][9];
    /**
     * A counter of the number of mistakes made by the player when their board is checked
     * for correctness.
     */
    ...
    /**
     * Initializes the start of the level.
     * @author Matthew Polter
     */
    ...
    /**
     * A boolean method to break the while loop of the Sudoku game when the player is finished.
     * 
     * @author Matthew Polter
    ...
    /**
     * Method for testing to check if there are any mistakes in the players Sudoku puzzle.
     * @return The number of mistakes the player has made.
     */
...
//        
//    	/**
//    	 * Scanner to read in player inputs for the game.
//    	 */
//        Scanner scan = new Scanner(System.in);
//        /**
//         * Testing Sudoku object.
//         */
