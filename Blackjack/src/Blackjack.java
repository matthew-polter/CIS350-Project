...
public class Blackjack {
     ...
     */
    public void checkAce(int ace, Scanner scan) {
    ...
    /**
     * @author Matthew Polter
     * @return Returns true if there is an ace remaining in the deck that
     * has already been checked and no longer needs a user prompt.
     */
